...
best_acc = 0
history = {}
for hidden_size, learning_rate in itertools.product(sizes, rates):
    ...
    val_acc = (net.predict(X_val) == y_val).mean()
    print 'Validation accuracy: ', val_acc
    history[(hidden_size, learning_rate)] = val_acc
    if val_acc > best_acc:
        best_net = net
        best_acc = val_acc
print history
print best_acc
#{(300, 0.002): 0.465, (200, 0.002): 0.49, (100, 0.003): 0.43, 
#(300, 0.003): 0.47, (100, 0.001): 0.47, (300, 0.001): 0.477, 
#(200, 0.003): 0.456, (200, 0.001): 0.469, (100, 0.002): 0.488}
#0.494
### very sensitive to learning_rate!!!
#################################################################################
#                               END OF YOUR CODE                                #
#################################################################################
